...
const ActivityDisplay = () => (
  <section className="activity-display-container" scrolling="no">
    <ul className="activities-display-list">
      <li>
        <iframe className="activity-video-content" width="560" height="315" src="https://www.youtube.com/embed/RrjJtYpOawU?start=61&controls=0&mute=1&autoplay=1" frameBorder="0"></iframe>
